function SignalRConnection(connection, connectCallback) {
    ...
    connection.socket = {
        send: function(data) {
            hub.server.send(channelName, JSON.stringify(data));
        }
    };

    var hub = $.connection.publicHub;
    ...
    function onMessagesCallback(message) {
        ...
        if (message.message.newParticipant) {
            ...
            mPeer.createNewPeer(message.message.newParticipant,
        ...
        if (message.message.newParticipationRequest && message.sender !== connection.userid) {
            ...
            var userPreferences = {
                ...
                dontGetRemoteStream: typeof message.message.isOneWay !== "undefined"
                    ? message.message.isOneWay
                    : !!connection.session.oneway || connection.direction === "one-way",
